# Sonatype Nexus Repository. IAC

[![GitHub](https://img.shields.io/github/v/release/fisher772/nexus?logo=github)](https://github.com/fisher772/nexus/releases)
[![GitHub](https://img.shields.io/badge/GitHub-Repo-blue%3Flogo%3Dgithub?logo=github&label=GitHub%20Repo)](https://github.com/fisher772/nexus)
...
[![GitHub Registry](https://img.shields.io/badge/ghrc.io-Registry-green?logo=github)](https://github.com/fisher772/nexus/pkgs/container/nexus)
[![Docker Registry](https://img.shields.io/badge/docker.io-Registry-green?logo=docker&logoColor=white&labelColor=blue)](https://hub.docker.com/r/fisher772/nexus)
...
[Nexus reference docs](https://help.sonatype.com/en/sonatype-nexus-repository.html)

Why do I need a Sonatype Nexus?
- For storing private artifacts
...
All you need to do to install Nexus:
...
- Move configuration files from the mounted volume nexus_nginx_conf to the volume with the nginx configuration files of the nginx container:
...
\* I recommend setting the NEXUS_CONTEXT variable to "/nexus". The configuration files are already set to this context, if you choose another one, you will need to correct the context path in the configuration file.
